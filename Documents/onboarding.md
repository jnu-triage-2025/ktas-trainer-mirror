...
|---|---|---|
| 시나리오 작성 | Documents/requirements/content-definitions/scenario/scenario-authoring-guide.md | Documents/requirements/content-definitions/scenario/*.md |
| 아이템 구현 | Documents/item-authoring.md | Assets/Modules/TriageTrainer/Scripts/Items/Definitions/\<ItemName\>.cs |
...
- 관련 문서 링크와 경로: 예) [Documents/requirements/content-definitions/scenario/scenario-graph-spec.md](requirements/content-definitions/scenario/scenario-graph-spec.md), [Documents/requirements/content-definitions/scenario/_template.md](requirements/content-definitions/scenario/_template.md)
