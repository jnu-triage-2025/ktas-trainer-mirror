# <a id="TriageTrainer_ItemDefinitions_CentralLineSet"></a> Class CentralLineSet

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class CentralLineSet : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_CentralLineSet_Description"></a> Description

```csharp
public const string Description = "중심정맥관 삽입을 위한 세트입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_CentralLineSet_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "C-line 세트"
```
...
### <a id="TriageTrainer_ItemDefinitions_CentralLineSet_Identifier"></a> Identifier

```csharp
public const string Identifier = "central_line_set"
```
