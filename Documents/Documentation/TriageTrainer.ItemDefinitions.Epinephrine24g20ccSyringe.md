# <a id="TriageTrainer_ItemDefinitions_Epinephrine24g20ccSyringe"></a> Class Epinephrine24g20ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

에피네프린이 든 24g 카테터 + 20cc 주사기 조합 완제품입니다.
Cannula24g + Syringe20cc + EpinephrineAmpule 를 조합하여 만든다.

```csharp
public class Epinephrine24g20ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine24g20ccSyringe_Description"></a> Description

```csharp
public const string Description = "24게이지 카테터가 연결된 20cc 주사기에 에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine24g20ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "에피네프린이 든 24g 20cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine24g20ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "epinephrine_24g_20cc_syringe"
```
