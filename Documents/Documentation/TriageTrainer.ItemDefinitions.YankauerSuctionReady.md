# <a id="TriageTrainer_ItemDefinitions_YankauerSuctionReady"></a> Class YankauerSuctionReady
...
### <a id="TriageTrainer_ItemDefinitions_YankauerSuctionReady_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_YankauerSuctionReady_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "조립된 양커 팁"
```
...
### <a id="TriageTrainer_ItemDefinitions_YankauerSuctionReady_Identifier"></a> Identifier
