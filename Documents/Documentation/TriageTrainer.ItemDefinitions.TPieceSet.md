# <a id="TriageTrainer_ItemDefinitions_TPieceSet"></a> Class TPieceSet

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class TPieceSet : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_TPieceSet_Description"></a> Description

```csharp
public const string Description = "환자에게 적용할 준비가 된 T-piece 세트입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_TPieceSet_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "T-piece 세트"
```
...
### <a id="TriageTrainer_ItemDefinitions_TPieceSet_Identifier"></a> Identifier

```csharp
public const string Identifier = "tpiece_set"
```
