# <a id="MultiplayerInfrastructure_Command_CommandDefinition_Help"></a> Class CommandDefinition\_Help
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Help__ctor_MultiplayerInfrastructure_Chat_ChatService_MultiplayerInfrastructure_Command_ChatCommandService_"></a> CommandDefinition\_Help\(ChatService, ChatCommandService\)
...
`service` [ChatCommandService](MultiplayerInfrastructure.Command.ChatCommandService.md)

## Properties

### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Help_CommandEntry"></a> CommandEntry
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Help_Description"></a> Description
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Help_PermissionIdentifier"></a> PermissionIdentifier
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Help_UsageLines"></a> UsageLines
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Help_Execute_FishNet_Connection_NetworkConnection_System_String___"></a> Execute\(NetworkConnection, string\[\]\)
