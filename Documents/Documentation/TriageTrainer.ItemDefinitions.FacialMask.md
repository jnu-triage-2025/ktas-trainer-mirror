# <a id="TriageTrainer_ItemDefinitions_FacialMask"></a> Class FacialMask

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class FacialMask : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_FacialMask_Description"></a> Description

```csharp
public const string Description = "지속적인 산소 공급을 위한 마스크입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_FacialMask_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "안면 마스크"
```
...
### <a id="TriageTrainer_ItemDefinitions_FacialMask_Identifier"></a> Identifier

```csharp
public const string Identifier = "facial_mask"
```
