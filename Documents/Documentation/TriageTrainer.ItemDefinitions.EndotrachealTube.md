# <a id="TriageTrainer_ItemDefinitions_EndotrachealTube"></a> Class EndotrachealTube

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class EndotrachealTube : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_EndotrachealTube_Description"></a> Description

```csharp
public const string Description = "기도 확보 시 Laryngoscope와 함께 사용합니다. [기관내관, 스타일렛]을 획득하면 [기관내관 (준비 완료)]으로 자동 조합됩니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_EndotrachealTube_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "기관내관"
```
...
### <a id="TriageTrainer_ItemDefinitions_EndotrachealTube_Identifier"></a> Identifier

```csharp
public const string Identifier = "endotracheal_tube"
```
