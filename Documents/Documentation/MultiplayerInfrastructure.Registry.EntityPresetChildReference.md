# <a id="MultiplayerInfrastructure_Registry_EntityPresetChildReference"></a> Struct EntityPresetChildReference
...
### <a id="MultiplayerInfrastructure_Registry_EntityPresetChildReference_childPresetIdentifier"></a> childPresetIdentifier

함께 스폰할 하위 엔티티 프리셋의 식별자. 이 식별자는 레지스트리에 등록된 다른 EntityPreset 이어야 한다.
...
### <a id="MultiplayerInfrastructure_Registry_EntityPresetChildReference_linkChildToParent"></a> linkChildToParent

활성화되면 하위 인스턴스가 <xref href="MultiplayerInfrastructure.Registry.IEntityPresetParentLinkReceiver" data-throw-if-not-resolved="false"></xref> 를 구현한 경우,
...
### <a id="MultiplayerInfrastructure_Registry_EntityPresetChildReference_spawnedEntityIdentifier"></a> spawnedEntityIdentifier
...
### <a id="MultiplayerInfrastructure_Registry_EntityPresetChildReference_unwrapOnSpawn"></a> unwrapOnSpawn
