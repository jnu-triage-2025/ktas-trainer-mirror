# <a id="TriageTrainer_ItemDefinitions_Cannula22g"></a> Class Cannula22g

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Cannula22g : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula22g_Description"></a> Description

```csharp
public const string Description = "수액 주입 시 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula22g_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "22게이지 캐뉼라"
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula22g_Identifier"></a> Identifier

```csharp
public const string Identifier = "cannula_22g"
```
