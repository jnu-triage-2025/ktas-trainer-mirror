# <a id="MultiplayerInfrastructure_Scenario_ScenarioReturnToOriginNode"></a> Class ScenarioReturnToOriginNode
...
### <a id="MultiplayerInfrastructure_Scenario_ScenarioReturnToOriginNode_Description"></a> Description

작성자용 메모. 실행에는 쓰이지 않는다.
...
### <a id="MultiplayerInfrastructure_Scenario_ScenarioReturnToOriginNode_Identifier"></a> Identifier
...
### <a id="MultiplayerInfrastructure_Scenario_ScenarioReturnToOriginNode_NextIdentifier"></a> NextIdentifier

사용하지 않는다. 곁가지는 이 노드에서 끝난다.
...
### <a id="MultiplayerInfrastructure_Scenario_ScenarioReturnToOriginNode_NodeType"></a> NodeType
