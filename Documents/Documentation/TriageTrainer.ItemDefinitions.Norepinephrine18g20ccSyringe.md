# <a id="TriageTrainer_ItemDefinitions_Norepinephrine18g20ccSyringe"></a> Class Norepinephrine18g20ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

노르에피네프린이 든 18g 카테터 + 20cc 주사기 조합 완제품입니다.
Cannula18g + Syringe20cc + NorepinephrineAmpule 를 조합하여 만든다.

```csharp
public class Norepinephrine18g20ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine18g20ccSyringe_Description"></a> Description

```csharp
public const string Description = "18게이지 카테터가 연결된 20cc 주사기에 노르에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine18g20ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "노르에피네프린이 든 18g 20cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine18g20ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "norepinephrine_18g_20cc_syringe"
```
