# <a id="TriageTrainer_ItemDefinitions_DefibrillatorPad"></a> Class DefibrillatorPad

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class DefibrillatorPad : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_DefibrillatorPad_Description"></a> Description

```csharp
public const string Description = "환자에게 전기 충격을 전달하기 위한 패드입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_DefibrillatorPad_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "전극 패드"
```
...
### <a id="TriageTrainer_ItemDefinitions_DefibrillatorPad_Identifier"></a> Identifier

```csharp
public const string Identifier = "defibrillatorpad"
```
