# <a id="TriageTrainer_ItemDefinitions_Norepinephrine20g5ccSyringe"></a> Class Norepinephrine20g5ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

노르에피네프린이 든 20g 카테터 + 5cc 주사기 조합 완제품입니다.
Cannula20g + Syringe5cc + NorepinephrineAmpule 를 조합하여 만든다.

```csharp
public class Norepinephrine20g5ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine20g5ccSyringe_Description"></a> Description

```csharp
public const string Description = "20게이지 카테터가 연결된 5cc 주사기에 노르에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine20g5ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "노르에피네프린이 든 20g 5cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine20g5ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "norepinephrine_20g_5cc_syringe"
```
