# <a id="TriageTrainer_ItemDefinitions_SterileDistilledWater"></a> Class SterileDistilledWater

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class SterileDistilledWater : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_SterileDistilledWater_Description"></a> Description

```csharp
public const string Description = "산소 투여 시 유량계를 채울 용액입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_SterileDistilledWater_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "멸균증류수"
```
...
### <a id="TriageTrainer_ItemDefinitions_SterileDistilledWater_Identifier"></a> Identifier

```csharp
public const string Identifier = "sterile_distilled_water"
```
