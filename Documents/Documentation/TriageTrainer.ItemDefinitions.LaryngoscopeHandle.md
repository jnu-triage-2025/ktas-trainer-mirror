# <a id="TriageTrainer_ItemDefinitions_LaryngoscopeHandle"></a> Class LaryngoscopeHandle

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class LaryngoscopeHandle : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_LaryngoscopeHandle_Description"></a> Description

```csharp
public const string Description = "후두경 블레이드와 결합하여 사용합니다. [후두경 블레이드, 후두경 손잡이]을 획득하면 [후두경]으로 자동 조합됩니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_LaryngoscopeHandle_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "후두경 손잡이"
```
...
### <a id="TriageTrainer_ItemDefinitions_LaryngoscopeHandle_Identifier"></a> Identifier

```csharp
public const string Identifier = "laryngoscope_handle"
```
