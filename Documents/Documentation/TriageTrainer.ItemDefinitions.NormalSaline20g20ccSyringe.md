# <a id="TriageTrainer_ItemDefinitions_NormalSaline20g20ccSyringe"></a> Class NormalSaline20g20ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

생리식염수가 든 20g 카테터 + 20cc 주사기 조합 완제품입니다.
Cannula20g + Syringe20cc + NormalSaline20ml 를 조합하여 만든다.

```csharp
public class NormalSaline20g20ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20g20ccSyringe_Description"></a> Description

```csharp
public const string Description = "20게이지 카테터가 연결된 20cc 주사기에 생리식염수가 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20g20ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "생리식염수가 든 20g 20cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20g20ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "normal_saline_20g_20cc_syringe"
```
