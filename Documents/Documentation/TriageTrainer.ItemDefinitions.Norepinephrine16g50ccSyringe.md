# <a id="TriageTrainer_ItemDefinitions_Norepinephrine16g50ccSyringe"></a> Class Norepinephrine16g50ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

노르에피네프린이 든 16g 카테터 + 50cc 주사기 조합 완제품입니다.
Cannula16g + Syringe50cc + NorepinephrineAmpule 를 조합하여 만든다.

```csharp
public class Norepinephrine16g50ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine16g50ccSyringe_Description"></a> Description

```csharp
public const string Description = "16게이지 카테터가 연결된 50cc 주사기에 노르에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine16g50ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "노르에피네프린이 든 16g 50cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine16g50ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "norepinephrine_16g_50cc_syringe"
```
