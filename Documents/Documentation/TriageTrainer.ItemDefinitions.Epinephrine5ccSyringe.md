# <a id="TriageTrainer_ItemDefinitions_Epinephrine5ccSyringe"></a> Class Epinephrine5ccSyringe
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine5ccSyringe_Description"></a> Description

```csharp
public const string Description = "5cc 주사기에 에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine5ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "에피네프린이 든 5cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine5ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "epinephrine_5cc_syringe"
```
