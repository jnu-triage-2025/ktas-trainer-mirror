# <a id="TriageTrainer_ItemDefinitions_NormalSaline1000ml"></a> Class NormalSaline1000ml

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class NormalSaline1000ml : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline1000ml_Description"></a> Description

```csharp
public const string Description = "생리식염수 1L."
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline1000ml_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "생리식염수 1L"
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline1000ml_Identifier"></a> Identifier

```csharp
public const string Identifier = "normal_saline_1000ml"
```
