# <a id="TriageTrainer_ItemDefinitions_ReservoirBag"></a> Class ReservoirBag

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class ReservoirBag : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_ReservoirBag_Description"></a> Description

```csharp
public const string Description = "앰부백에 연결해 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_ReservoirBag_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "보유주머니(reservoir bag)"
```
...
### <a id="TriageTrainer_ItemDefinitions_ReservoirBag_Identifier"></a> Identifier

```csharp
public const string Identifier = "reservoir_bag"
```
