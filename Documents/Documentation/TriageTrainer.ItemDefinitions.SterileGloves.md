# <a id="TriageTrainer_ItemDefinitions_SterileGloves"></a> Class SterileGloves
...
### <a id="TriageTrainer_ItemDefinitions_SterileGloves_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_SterileGloves_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "멸균 장갑"
```
...
### <a id="TriageTrainer_ItemDefinitions_SterileGloves_Identifier"></a> Identifier
