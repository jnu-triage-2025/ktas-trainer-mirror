# <a id="TriageTrainer_Entity_WallAttachedWallSuction"></a> Class WallAttachedWallSuction
...
public class WallAttachedWallSuction : StaticObjectDisplayment, IInteractable, IInteract, IInteractDisplayIcons, IQuestPresentationTarget, IInteractorConditional, INearestOnlyInteract, IAttachCompletionSignalConfigurable
```
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_DisplayIcons"></a> DisplayIcons
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_DisplayText"></a> DisplayText
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_EntityIdPrefix"></a> EntityIdPrefix
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_InteractionIdentifier"></a> InteractionIdentifier
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_Interacts"></a> Interacts
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_IsAttached"></a> IsAttached
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_NearestOnlyCollider"></a> NearestOnlyCollider
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_NearestOnlyDistanceOrigin"></a> NearestOnlyDistanceOrigin
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_NearestOnlyGroup"></a> NearestOnlyGroup
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_NearestOnlyTieBreaker"></a> NearestOnlyTieBreaker
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_PresentationEntityIdentifier"></a> PresentationEntityIdentifier
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_SuctionLineConnectionPoint"></a> SuctionLineConnectionPoint

석션 라인 자동 연결에 사용할 장비 측 포트. 프리팹에 설정되지 않으면 null이다.

```csharp
public SuctionLineConnectionPoint SuctionLineConnectionPoint { get; }
```
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_ApplyHiddenFromNetwork"></a> ApplyHiddenFromNetwork\(\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_ApplyInitialVisibility"></a> ApplyInitialVisibility\(\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_ApplyShownFromNetwork"></a> ApplyShownFromNetwork\(\)

이 오브젝트가 표시(설치/적용)될 때 로컬 표현에 반영한다(모든 클라이언트에서 실행).
표시와 함께 <xref href="TriageTrainer.Entity.WallAttachedWallSuction.IsAttached" data-throw-if-not-resolved="false"></xref> 를 확정한다. 완료 신호는 "최초 확정 시 1회"만 필요하므로
여기가 아니라 <xref href="TriageTrainer.Entity.WallAttachedWallSuction.OnShownConfirmed" data-throw-if-not-resolved="false"></xref> 에서 처리한다(옵저버 중복 실행 방지).

```csharp
public override void ApplyShownFromNetwork()
```

### <a id="TriageTrainer_Entity_WallAttachedWallSuction_CanInteract_UnityEngine_Transform_"></a> CanInteract\(Transform\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_Detach"></a> Detach\(\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_Interact_UnityEngine_Transform_"></a> Interact\(Transform\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_OnHiddenConfirmed"></a> OnHiddenConfirmed\(\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_OnShownConfirmed"></a> OnShownConfirmed\(\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_SetAttachCompletionSignalForEditor_System_String_"></a> SetAttachCompletionSignalForEditor\(string\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_TryGetServerSharedItemExchange_System_String__System_Int32__"></a> TryGetServerSharedItemExchange\(out string, out int\)
...
### <a id="TriageTrainer_Entity_WallAttachedWallSuction_AttachmentStateChanged"></a> AttachmentStateChanged
...
#### Event Type
 ...
 Action<[WallAttachedWallSuction](TriageTrainer.Entity.WallAttachedWallSuction.md), bool\>

### <a id="TriageTrainer_Entity_WallAttachedWallSuction_InstallationConfirmed"></a> InstallationConfirmed
...
#### Event Type
 ...
 Action<[WallAttachedWallSuction](TriageTrainer.Entity.WallAttachedWallSuction.md)\>
