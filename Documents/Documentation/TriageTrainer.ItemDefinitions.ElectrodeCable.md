# <a id="TriageTrainer_ItemDefinitions_ElectrodeCable"></a> Class ElectrodeCable

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class ElectrodeCable : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_ElectrodeCable_Description"></a> Description

```csharp
public const string Description = "환자에게 적용된 전극과 모니터를 연결하는 케이블입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_ElectrodeCable_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "전극 케이블"
```
...
### <a id="TriageTrainer_ItemDefinitions_ElectrodeCable_Identifier"></a> Identifier

```csharp
public const string Identifier = "electrode_cable"
```
