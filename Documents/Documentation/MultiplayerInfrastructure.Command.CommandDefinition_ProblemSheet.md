# <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet"></a> Class CommandDefinition\_ProblemSheet
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet__ctor_MultiplayerInfrastructure_Chat_ChatService_"></a> CommandDefinition\_ProblemSheet\(ChatService\)
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet_CommandEntry"></a> CommandEntry
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet_Description"></a> Description
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet_PermissionIdentifier"></a> PermissionIdentifier
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet_UsageLines"></a> UsageLines
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet_Execute_FishNet_Connection_NetworkConnection_System_String___"></a> Execute\(NetworkConnection, string\[\]\)
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_ProblemSheet_TryExecute_FishNet_Connection_NetworkConnection_System_String___System_Boolean_System_Collections_Generic_IReadOnlyList_System_String___System_String__"></a> TryExecute\(NetworkConnection, string\[\], bool, out IReadOnlyList<string\>, out string\)
