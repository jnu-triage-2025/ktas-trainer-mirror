# <a id="TriageTrainer_ItemDefinitions_Cannula24g"></a> Class Cannula24g

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Cannula24g : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula24g_Description"></a> Description

```csharp
public const string Description = "혈관이 작은 성인이나 소아에게 수액을 느린 속도로 투여할 때 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula24g_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "24게이지 캐뉼라"
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula24g_Identifier"></a> Identifier

```csharp
public const string Identifier = "cannula_24g"
```
