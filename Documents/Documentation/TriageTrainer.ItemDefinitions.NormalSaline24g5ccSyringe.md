# <a id="TriageTrainer_ItemDefinitions_NormalSaline24g5ccSyringe"></a> Class NormalSaline24g5ccSyringe
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline24g5ccSyringe_Description"></a> Description

```csharp
public const string Description = "24게이지 카테터가 연결된 5cc 주사기에 생리식염수가 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline24g5ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "생리식염수가 든 24g 5cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline24g5ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "normal_saline_24g_5cc_syringe"
```
