# <a id="MultiplayerInfrastructure_Command_CommandDefinition_Signal"></a> Class CommandDefinition\_Signal
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Signal__ctor_MultiplayerInfrastructure_Chat_ChatService_"></a> CommandDefinition\_Signal\(ChatService\)

```csharp
public CommandDefinition_Signal(ChatService chat)
```
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Signal_CommandEntry"></a> CommandEntry
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Signal_Description"></a> Description
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Signal_PermissionIdentifier"></a> PermissionIdentifier
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Signal_UsageLines"></a> UsageLines
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Signal_Execute_FishNet_Connection_NetworkConnection_System_String___"></a> Execute\(NetworkConnection, string\[\]\)
