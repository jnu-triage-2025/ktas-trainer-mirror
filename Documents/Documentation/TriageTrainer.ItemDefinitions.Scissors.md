# <a id="TriageTrainer_ItemDefinitions_Scissors"></a> Class Scissors
...
### <a id="TriageTrainer_ItemDefinitions_Scissors_DeltaDurabilityOnUse"></a> DeltaDurabilityOnUse

```csharp
public const int DeltaDurabilityOnUse = -1
```
...
### <a id="TriageTrainer_ItemDefinitions_Scissors_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_Scissors_DisplayName"></a> DisplayName
...
### <a id="TriageTrainer_ItemDefinitions_Scissors_EnabledDeltaDurability"></a> EnabledDeltaDurability
...
### <a id="TriageTrainer_ItemDefinitions_Scissors_HasDurability"></a> HasDurability
...
### <a id="TriageTrainer_ItemDefinitions_Scissors_Identifier"></a> Identifier
...
### <a id="TriageTrainer_ItemDefinitions_Scissors_MaxDurability"></a> MaxDurability

```csharp
public const int MaxDurability = 16
```
