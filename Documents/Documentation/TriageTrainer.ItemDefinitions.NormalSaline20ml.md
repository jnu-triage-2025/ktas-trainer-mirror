# <a id="TriageTrainer_ItemDefinitions_NormalSaline20ml"></a> Class NormalSaline20ml

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class NormalSaline20ml : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20ml_Description"></a> Description

```csharp
public const string Description = "생리식염수 20ml."
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20ml_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "생리식염수 20ml"
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20ml_Identifier"></a> Identifier

```csharp
public const string Identifier = "normal_saline_20ml"
```
