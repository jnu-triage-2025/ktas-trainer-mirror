# <a id="TriageTrainer_ItemDefinitions_NormalSaline20g50ccSyringe"></a> Class NormalSaline20g50ccSyringe
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20g50ccSyringe_Description"></a> Description

```csharp
public const string Description = "20게이지 카테터가 연결된 50cc 주사기에 생리식염수가 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20g50ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "생리식염수가 든 20g 50cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline20g50ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "normal_saline_20g_50cc_syringe"
```
