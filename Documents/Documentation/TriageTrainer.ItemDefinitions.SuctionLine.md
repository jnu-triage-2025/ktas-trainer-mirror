# <a id="TriageTrainer_ItemDefinitions_SuctionLine"></a> Class SuctionLine

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class SuctionLine : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_SuctionLine_Description"></a> Description

```csharp
public const string Description = "흡인 카테터와 흡인기를 연결하는 투명 관."
```
...
### <a id="TriageTrainer_ItemDefinitions_SuctionLine_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "석션 라인"
```
...
### <a id="TriageTrainer_ItemDefinitions_SuctionLine_Identifier"></a> Identifier

```csharp
public const string Identifier = "suction_line"
```
