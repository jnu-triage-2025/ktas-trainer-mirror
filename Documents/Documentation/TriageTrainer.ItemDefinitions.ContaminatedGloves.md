# <a id="TriageTrainer_ItemDefinitions_ContaminatedGloves"></a> Class ContaminatedGloves
...
### <a id="TriageTrainer_ItemDefinitions_ContaminatedGloves_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_ContaminatedGloves_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "오염된 장갑"
```
...
### <a id="TriageTrainer_ItemDefinitions_ContaminatedGloves_Identifier"></a> Identifier

```csharp
public const string Identifier = "contaminated_gloves"
```
