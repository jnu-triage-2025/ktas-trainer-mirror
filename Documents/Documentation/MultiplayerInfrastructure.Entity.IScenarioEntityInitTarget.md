# <a id="MultiplayerInfrastructure_Entity_IScenarioEntityInitTarget"></a> Interface IScenarioEntityInitTarget
...
### <a id="MultiplayerInfrastructure_Entity_IScenarioEntityInitTarget_ApplyScenarioDisplayState_System_String_System_Boolean_"></a> ApplyScenarioDisplayState\(string, bool\)
...
구현체가 이름을 인식하여 적용했으면 true.

### <a id="MultiplayerInfrastructure_Entity_IScenarioEntityInitTarget_SyncAllDisplayStatesNetworked"></a> SyncAllDisplayStatesNetworked\(\)
