# <a id="TriageTrainer_ItemDefinitions_Electrode"></a> Class Electrode
...
### <a id="TriageTrainer_ItemDefinitions_Electrode_Description"></a> Description

```csharp
public const string Description = "심전도를 읽기 위해 환자에게 부착할 전극입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Electrode_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "전극"
```
...
### <a id="TriageTrainer_ItemDefinitions_Electrode_Identifier"></a> Identifier

```csharp
public const string Identifier = "electrode"
```
