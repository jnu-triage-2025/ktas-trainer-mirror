# <a id="TriageTrainer_ItemDefinitions_NasalCannula"></a> Class NasalCannula

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class NasalCannula : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_NasalCannula_Description"></a> Description

```csharp
public const string Description = "환자에게 산소를 공급할 때 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_NasalCannula_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "비강 캐뉼라"
```
...
### <a id="TriageTrainer_ItemDefinitions_NasalCannula_Identifier"></a> Identifier

```csharp
public const string Identifier = "nasal_cannula"
```
