# <a id="TriageTrainer_Entity_SuctionLine_SuctionLineConnectionPoint"></a> Class SuctionLineConnectionPoint

Namespace: [TriageTrainer.Entity.SuctionLine](TriageTrainer.Entity.SuctionLine.md)  
...
### <a id="TriageTrainer_Entity_SuctionLine_SuctionLineConnectionPoint_Elasticity"></a> Elasticity

```csharp
public const float Elasticity = 0.13
```
...
### <a id="TriageTrainer_Entity_SuctionLine_SuctionLineConnectionPoint_LineWidth"></a> LineWidth

```csharp
public const float LineWidth = 0.04
```
...
### <a id="TriageTrainer_Entity_SuctionLine_SuctionLineConnectionPoint_MaterialResourcePath"></a> MaterialResourcePath
...
### <a id="TriageTrainer_Entity_SuctionLine_SuctionLineConnectionPoint_DefaultMaterial"></a> DefaultMaterial
...
### <a id="TriageTrainer_Entity_SuctionLine_SuctionLineConnectionPoint_ApplyLineMaterial_UnityEngine_LineRenderer_"></a> ApplyLineMaterial\(LineRenderer\)
