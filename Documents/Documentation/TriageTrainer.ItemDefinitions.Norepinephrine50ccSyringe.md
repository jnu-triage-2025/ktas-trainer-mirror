# <a id="TriageTrainer_ItemDefinitions_Norepinephrine50ccSyringe"></a> Class Norepinephrine50ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

노르에피네프린이 든 50cc 주사기(카테터 없음) 조합 완제품입니다.
Syringe50cc + NorepinephrineAmpule 를 조합하여 만든다.

```csharp
public class Norepinephrine50ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine50ccSyringe_Description"></a> Description

```csharp
public const string Description = "50cc 주사기에 노르에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine50ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "노르에피네프린이 든 50cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Norepinephrine50ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "norepinephrine_50cc_syringe"
```
