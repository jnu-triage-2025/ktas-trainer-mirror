# <a id="TriageTrainer_ItemDefinitions_PlasmaSolution1000ml"></a> Class PlasmaSolution1000ml

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class PlasmaSolution1000ml : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_PlasmaSolution1000ml_Description"></a> Description

```csharp
public const string Description = "혈장 대용 수액(플라즈마 솔루션) 1L."
```
...
### <a id="TriageTrainer_ItemDefinitions_PlasmaSolution1000ml_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "플라즈마 솔루션 1L"
```
...
### <a id="TriageTrainer_ItemDefinitions_PlasmaSolution1000ml_Identifier"></a> Identifier

```csharp
public const string Identifier = "plasma_solution_1000ml"
```
