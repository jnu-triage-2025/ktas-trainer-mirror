# <a id="TriageTrainer_Utils_EntityPresetDebugger"></a> Class EntityPresetDebugger

Namespace: [TriageTrainer.Utils](TriageTrainer.Utils.md)  
...
### <a id="TriageTrainer_Utils_EntityPresetDebugger_DespawnDebugSpawns"></a> DespawnDebugSpawns\(\)
...
### <a id="TriageTrainer_Utils_EntityPresetDebugger_ListRegisteredPresets"></a> ListRegisteredPresets\(\)
...
### <a id="TriageTrainer_Utils_EntityPresetDebugger_RegisterPresetsFromSO"></a> RegisterPresetsFromSO\(\)
...
### <a id="TriageTrainer_Utils_EntityPresetDebugger_ReportRegisteredEntities"></a> ReportRegisteredEntities\(\)
...
### <a id="TriageTrainer_Utils_EntityPresetDebugger_SpawnAllPresets"></a> SpawnAllPresets\(\)
...
### <a id="TriageTrainer_Utils_EntityPresetDebugger_SpawnSelectedPreset"></a> SpawnSelectedPreset\(\)
