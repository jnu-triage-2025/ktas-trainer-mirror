# <a id="MultiplayerInfrastructure_Registry_IEntityPresetParentLinkReceiver"></a> Interface IEntityPresetParentLinkReceiver
...
### <a id="MultiplayerInfrastructure_Registry_IEntityPresetParentLinkReceiver_ApplyParentEntityIdentifier_System_String_"></a> ApplyParentEntityIdentifier\(string\)

스폰된 부모(루트) 프리셋 인스턴스의 런타임 엔티티 식별자를 전달받는다.
