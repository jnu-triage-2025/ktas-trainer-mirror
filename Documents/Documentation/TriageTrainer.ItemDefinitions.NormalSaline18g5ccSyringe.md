# <a id="TriageTrainer_ItemDefinitions_NormalSaline18g5ccSyringe"></a> Class NormalSaline18g5ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

생리식염수가 든 18g 카테터 + 5cc 주사기 조합 완제품입니다.
Cannula18g + Syringe5cc + NormalSaline20ml 를 조합하여 만든다.

```csharp
public class NormalSaline18g5ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline18g5ccSyringe_Description"></a> Description

```csharp
public const string Description = "18게이지 카테터가 연결된 5cc 주사기에 생리식염수가 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline18g5ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "생리식염수가 든 18g 5cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_NormalSaline18g5ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "normal_saline_18g_5cc_syringe"
```
