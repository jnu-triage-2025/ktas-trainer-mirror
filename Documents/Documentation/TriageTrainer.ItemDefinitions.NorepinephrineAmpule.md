# <a id="TriageTrainer_ItemDefinitions_NorepinephrineAmpule"></a> Class NorepinephrineAmpule

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class NorepinephrineAmpule : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_NorepinephrineAmpule_Description"></a> Description

```csharp
public const string Description = "혈압 저하 시 승압제로 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_NorepinephrineAmpule_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "노르에피네프린"
```
...
### <a id="TriageTrainer_ItemDefinitions_NorepinephrineAmpule_Identifier"></a> Identifier

```csharp
public const string Identifier = "norepinephrine_ampule"
```
