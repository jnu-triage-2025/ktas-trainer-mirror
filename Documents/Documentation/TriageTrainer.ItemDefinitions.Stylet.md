# <a id="TriageTrainer_ItemDefinitions_Stylet"></a> Class Stylet

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Stylet : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Stylet_Description"></a> Description

```csharp
public const string Description = "기관내관 삽입 시 사용합니다. [기관내관, 스타일렛]을 획득하면 [기관내관 (준비 완료)]으로 자동 조합됩니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Stylet_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "스타일렛"
```
...
### <a id="TriageTrainer_ItemDefinitions_Stylet_Identifier"></a> Identifier

```csharp
public const string Identifier = "stylet"
```
