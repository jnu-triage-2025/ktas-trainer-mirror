# <a id="MultiplayerInfrastructure_Camera_CameraAttachPoint"></a> Class CameraAttachPoint
...
### <a id="MultiplayerInfrastructure_Camera_CameraAttachPoint_AttachmentRoot"></a> AttachmentRoot
...
### <a id="MultiplayerInfrastructure_Camera_CameraAttachPoint_OwnerColliders"></a> OwnerColliders
...
### <a id="MultiplayerInfrastructure_Camera_CameraAttachPoint_PivotTransform"></a> PivotTransform
...
### <a id="MultiplayerInfrastructure_Camera_CameraAttachPoint_Create_UnityEngine_Transform_System_Single_"></a> Create\(Transform, float\)

지정한 부모 아래에 "CameraAttachPoint"라는 이름의 부착점 GameObject를 생성합니다.

```csharp
public static CameraAttachPoint Create(Transform parent, float localHeightOffset = 0)
```
...
### <a id="MultiplayerInfrastructure_Camera_CameraAttachPoint_SetPitch_System_Single_"></a> SetPitch\(float\)
