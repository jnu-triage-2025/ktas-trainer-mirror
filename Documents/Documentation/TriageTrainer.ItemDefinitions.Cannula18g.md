# <a id="TriageTrainer_ItemDefinitions_Cannula18g"></a> Class Cannula18g

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Cannula18g : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula18g_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_Cannula18g_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "18게이지 캐뉼라"
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula18g_Identifier"></a> Identifier

```csharp
public const string Identifier = "cannula_18g"
```
