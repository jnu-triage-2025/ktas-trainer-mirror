# <a id="TriageTrainer_ItemDefinitions_Syringe5cc"></a> Class Syringe5cc

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Syringe5cc : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Syringe5cc_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_Syringe5cc_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "5cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Syringe5cc_Identifier"></a> Identifier

```csharp
public const string Identifier = "syringe_5cc"
```
