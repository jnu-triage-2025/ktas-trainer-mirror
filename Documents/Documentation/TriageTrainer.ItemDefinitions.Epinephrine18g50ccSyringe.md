# <a id="TriageTrainer_ItemDefinitions_Epinephrine18g50ccSyringe"></a> Class Epinephrine18g50ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

에피네프린이 든 18g 카테터 + 50cc 주사기 조합 완제품입니다.
Cannula18g + Syringe50cc + EpinephrineAmpule 를 조합하여 만든다.

```csharp
public class Epinephrine18g50ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine18g50ccSyringe_Description"></a> Description

```csharp
public const string Description = "18게이지 카테터가 연결된 50cc 주사기에 에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine18g50ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "에피네프린이 든 18g 50cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine18g50ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "epinephrine_18g_50cc_syringe"
```
