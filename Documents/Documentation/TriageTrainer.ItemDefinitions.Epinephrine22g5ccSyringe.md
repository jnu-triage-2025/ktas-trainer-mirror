# <a id="TriageTrainer_ItemDefinitions_Epinephrine22g5ccSyringe"></a> Class Epinephrine22g5ccSyringe

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

에피네프린이 든 22g 카테터 + 5cc 주사기 조합 완제품입니다.
Cannula22g + Syringe5cc + EpinephrineAmpule 를 조합하여 만든다.

```csharp
public class Epinephrine22g5ccSyringe : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine22g5ccSyringe_Description"></a> Description

```csharp
public const string Description = "22게이지 카테터가 연결된 5cc 주사기에 에피네프린이 준비되어 있습니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine22g5ccSyringe_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "에피네프린이 든 22g 5cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Epinephrine22g5ccSyringe_Identifier"></a> Identifier

```csharp
public const string Identifier = "epinephrine_22g_5cc_syringe"
```
