# <a id="TriageTrainer_ItemDefinitions_CervicalCollar"></a> Class CervicalCollar

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class CervicalCollar : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_CervicalCollar_Description"></a> Description

```csharp
public const string Description = "환자의 경추를 고정할 때 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_CervicalCollar_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "경추 고정기"
```
...
### <a id="TriageTrainer_ItemDefinitions_CervicalCollar_Identifier"></a> Identifier

```csharp
public const string Identifier = "cervical_collar"
```
