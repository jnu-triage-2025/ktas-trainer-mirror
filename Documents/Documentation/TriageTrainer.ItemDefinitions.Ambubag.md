# <a id="TriageTrainer_ItemDefinitions_Ambubag"></a> Class Ambubag
...
### <a id="TriageTrainer_ItemDefinitions_Ambubag_Description"></a> Description

```csharp
public const string Description = "응급 상황 등 산소 공급이 급히 필요할 때 보유주머니(reservoir bag)와 산소연결줄을 연결해 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Ambubag_DisplayName"></a> DisplayName
...
### <a id="TriageTrainer_ItemDefinitions_Ambubag_Identifier"></a> Identifier
