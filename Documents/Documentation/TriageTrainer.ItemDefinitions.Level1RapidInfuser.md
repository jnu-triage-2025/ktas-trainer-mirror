# <a id="TriageTrainer_ItemDefinitions_Level1RapidInfuser"></a> Class Level1RapidInfuser

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

월드에 Level 1 급속 주입기를 배치하는 아이템.
...
### <a id="TriageTrainer_ItemDefinitions_Level1RapidInfuser_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_Level1RapidInfuser_DisplayName"></a> DisplayName
...
### <a id="TriageTrainer_ItemDefinitions_Level1RapidInfuser_Identifier"></a> Identifier
...
### <a id="TriageTrainer_ItemDefinitions_Level1RapidInfuser_IsStackable"></a> IsStackable
...
### <a id="TriageTrainer_ItemDefinitions_Level1RapidInfuser_MaxStackCount"></a> MaxStackCount
...
### <a id="TriageTrainer_ItemDefinitions_Level1RapidInfuser_OnUse_MultiplayerInfrastructure_Player_PlayerController_MultiplayerInfrastructure_Entity_Entity_"></a> OnUse\(PlayerController, Entity\)
