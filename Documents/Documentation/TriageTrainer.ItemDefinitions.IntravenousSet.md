# <a id="TriageTrainer_ItemDefinitions_IntravenousSet"></a> Class IntravenousSet
...
### <a id="TriageTrainer_ItemDefinitions_IntravenousSet_Description"></a> Description

```csharp
public const string Description = "수액 주입시 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_IntravenousSet_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "수액세트"
```
...
### <a id="TriageTrainer_ItemDefinitions_IntravenousSet_Identifier"></a> Identifier

```csharp
public const string Identifier = "intravenous_set"
```
