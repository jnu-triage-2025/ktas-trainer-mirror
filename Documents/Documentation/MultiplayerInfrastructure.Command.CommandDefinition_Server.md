# <a id="MultiplayerInfrastructure_Command_CommandDefinition_Server"></a> Class CommandDefinition\_Server
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Server__ctor_MultiplayerInfrastructure_Chat_ChatService_"></a> CommandDefinition\_Server\(ChatService\)

```csharp
public CommandDefinition_Server(ChatService chat)
```
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Server_CommandEntry"></a> CommandEntry
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Server_Description"></a> Description
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Server_PermissionIdentifier"></a> PermissionIdentifier
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Server_UsageLines"></a> UsageLines
...
### <a id="MultiplayerInfrastructure_Command_CommandDefinition_Server_Execute_FishNet_Connection_NetworkConnection_System_String___"></a> Execute\(NetworkConnection, string\[\]\)
