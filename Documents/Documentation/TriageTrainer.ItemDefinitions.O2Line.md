# <a id="TriageTrainer_ItemDefinitions_O2Line"></a> Class O2Line

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class O2Line : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_O2Line_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_O2Line_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "산소 연결줄"
```
...
### <a id="TriageTrainer_ItemDefinitions_O2Line_Identifier"></a> Identifier

```csharp
public const string Identifier = "o2_line"
```
