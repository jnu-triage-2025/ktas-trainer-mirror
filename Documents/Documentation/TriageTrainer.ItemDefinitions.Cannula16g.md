# <a id="TriageTrainer_ItemDefinitions_Cannula16g"></a> Class Cannula16g

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Cannula16g : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula16g_Description"></a> Description

```csharp
public const string Description = "성인의 수혈 및 대량의 수액 공급 시 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula16g_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "16게이지 캐뉼라"
```
...
### <a id="TriageTrainer_ItemDefinitions_Cannula16g_Identifier"></a> Identifier

```csharp
public const string Identifier = "cannula_16g"
```
