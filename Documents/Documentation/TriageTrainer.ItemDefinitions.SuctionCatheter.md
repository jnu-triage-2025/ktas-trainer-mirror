# <a id="TriageTrainer_ItemDefinitions_SuctionCatheter"></a> Class SuctionCatheter

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class SuctionCatheter : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_SuctionCatheter_Description"></a> Description

```csharp
public const string Description = "구강 내 분비물 흡인 시 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_SuctionCatheter_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "석션 카테터"
```
...
### <a id="TriageTrainer_ItemDefinitions_SuctionCatheter_Identifier"></a> Identifier

```csharp
public const string Identifier = "suction_catheter"
```
