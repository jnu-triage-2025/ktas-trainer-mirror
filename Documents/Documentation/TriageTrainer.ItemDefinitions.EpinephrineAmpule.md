# <a id="TriageTrainer_ItemDefinitions_EpinephrineAmpule"></a> Class EpinephrineAmpule

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class EpinephrineAmpule : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_EpinephrineAmpule_Description"></a> Description

```csharp
public const string Description = "쇼크 및 심정지 시 혈압과 맥박수를 올리기 위한 약물입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_EpinephrineAmpule_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "에피네프린"
```
...
### <a id="TriageTrainer_ItemDefinitions_EpinephrineAmpule_Identifier"></a> Identifier

```csharp
public const string Identifier = "epinephrine_ampule"
```
