# <a id="TriageTrainer_ItemDefinitions_Syringe20cc"></a> Class Syringe20cc

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Syringe20cc : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Syringe20cc_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_Syringe20cc_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "20cc 주사기"
```
...
### <a id="TriageTrainer_ItemDefinitions_Syringe20cc_Identifier"></a> Identifier

```csharp
public const string Identifier = "syringe_20cc"
```
