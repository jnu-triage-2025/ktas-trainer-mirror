# <a id="TriageTrainer_ItemDefinitions_Flowmeter"></a> Class Flowmeter

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class Flowmeter : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_Flowmeter_Description"></a> Description
...
### <a id="TriageTrainer_ItemDefinitions_Flowmeter_DisplayName"></a> DisplayName
...
### <a id="TriageTrainer_ItemDefinitions_Flowmeter_Identifier"></a> Identifier
