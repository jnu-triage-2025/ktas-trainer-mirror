# <a id="MultiplayerInfrastructure_ItemSystem_StaticPlacedItemVanishBehavior"></a> Enum StaticPlacedItemVanishBehavior
...
게임 오브젝트를 비활성화(<code>SetActive(false)</code>)한다.
...
여전히 보이지만 상호작용(획득)만 비활성화한다.



`Invisible = 0` 

(기본값) 렌더러를 꺼서 보이지 않게 한다. 상호작용도 함께 비활성화된다.
