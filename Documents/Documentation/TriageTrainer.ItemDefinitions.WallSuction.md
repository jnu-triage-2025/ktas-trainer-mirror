# <a id="TriageTrainer_ItemDefinitions_WallSuction"></a> Class WallSuction

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class WallSuction : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_WallSuction_Description"></a> Description

```csharp
public const string Description = "흡인 시 벽에 꽂아 압력 및 전원 조절 시 사용."
```
...
### <a id="TriageTrainer_ItemDefinitions_WallSuction_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "흡인기"
```
...
### <a id="TriageTrainer_ItemDefinitions_WallSuction_Identifier"></a> Identifier

```csharp
public const string Identifier = "wall_suction"
```
