# <a id="TriageTrainer_ItemDefinitions_VitalSet"></a> Class VitalSet
...
### <a id="TriageTrainer_ItemDefinitions_VitalSet_Description"></a> Description

```csharp
public const string Description = "활력징후를 측정하기 위한 혈압계, 청진기, 체온계입니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_VitalSet_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "활력징후 측정도구"
```
...
### <a id="TriageTrainer_ItemDefinitions_VitalSet_Identifier"></a> Identifier

```csharp
public const string Identifier = "vital_set"
```
