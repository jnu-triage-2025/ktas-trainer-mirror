# <a id="TriageTrainer_ItemDefinitions_ElasticBand"></a> Class ElasticBand

Namespace: [TriageTrainer.ItemDefinitions](TriageTrainer.ItemDefinitions.md)  
Assembly: Assembly\-CSharp.dll  

```csharp
public class ElasticBand : MedicalItem
```
...
### <a id="TriageTrainer_ItemDefinitions_ElasticBand_Description"></a> Description

```csharp
public const string Description = "지혈 시 거즈와 함께 고정용으로 사용합니다."
```
...
### <a id="TriageTrainer_ItemDefinitions_ElasticBand_DisplayName"></a> DisplayName

```csharp
public const string DisplayName = "압박붕대"
```
...
### <a id="TriageTrainer_ItemDefinitions_ElasticBand_Identifier"></a> Identifier

```csharp
public const string Identifier = "elasticband"
```
