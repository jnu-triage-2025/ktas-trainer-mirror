...
> 에셋을 변환 근거로 사용하지 않는다. 아래 감사와 본문의 명시된 명세만으로 새
...
- TUT-QUEST-1의 세 quest definition과 task 완료 명세가 등록되어야 한다.
