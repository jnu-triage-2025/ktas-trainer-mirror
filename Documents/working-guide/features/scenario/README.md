# working-guide/features/scenario
...
시나리오 운영, 변환, 검증, 레지스트리 보조 문서를 정리합니다.
...
- [implementation-prep.md](./implementation-prep.md): 재난 시나리오 미구현 기능 구현 준비서 (보관용)
...
- [scenario-ingame-requirements-support-guide.md](./scenario-ingame-requirements-support-guide.md): Scenario 인게임 요구사항 계약 운영 가이드
