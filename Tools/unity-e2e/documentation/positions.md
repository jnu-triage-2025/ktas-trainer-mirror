...
### `patient_b_c_ct`에서 실제 검증한 CT 이송 경로

2026-09-10의 4인 E2E 실행 `eac5f125-5034-4595-be20-f106cce570ba`에서 다음 경로로 환자 B와 C의 CT 도착 신호를 모두 확인했다. 환자 C 침대는 B 침대의 첫 대각선 경로를 재사용하지 않는다. `(-64,-17)`에서 L4와 수직 통로의 겹침점을 직교로 통과해야 하며, 대각선으로 모서리를 자르면 참가자 제어가 해제될 수 있다.

```json
{
  "bedBToCt": [[-68.125, 0, -15.31], [-68.7125, 0, -13.87], [-76.5175, 0, -13.87], [-77.2375, 0, -21.76], [-80.1175, 0, -21.76], [-80, 0, -18.3]],
  "bedCToCt": [[-68.2, 0, -15.5], [-68.2, 0, -13.87], [-68.7, 0, -13.87], [-76.5175, 0, -13.87], [-77.2375, 0, -21.76], [-80.1175, 0, -21.76], [-80, 0, -18.3]],
  "returnAfterBedB": [[-80.12, 0, -21.76], [-77.24, 0, -21.76], [-76.52, 0, -13.87], [-68.71, 0, -13.87]]
}
```

CT 출입구의 복귀 동선은 플레이어 캡슐 네 개가 동시에 통과하면 서로 막힐 수 있으므로 한 명씩 통과시킨다. CT 도착 트리거는 도착 신호를 등록하면서 침대 참가자를 자동 해제할 수 있으므로, 마지막 좌표 관찰보다 `sig.ct_patient_arrived_patient_b`와 `sig.ct_patient_arrived_patient_c`를 성공 기준으로 사용한다.
