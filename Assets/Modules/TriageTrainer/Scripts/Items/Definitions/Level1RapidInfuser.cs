...
namespace TriageTrainer.ItemDefinitions
{
  ...
  {
    public new const string Identifier = "level1_rapid_infuser";
    public new const string DisplayName = "Level 1 급속 주입기";
    public new const string Description = "우클릭하여 바라보는 방향 앞에 급속 주입기를 배치합니다.";
    ...
    {
      if (player != null)
        player.RequestPlaceHeldEntityPrefab(Identifier);
