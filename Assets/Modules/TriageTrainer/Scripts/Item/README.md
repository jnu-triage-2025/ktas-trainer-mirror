...
`ItemDataModelSO`를 생성하면, 이러한 에셋을 한 곳에 모아 관리하는 것이 좋습니다. 현재는 `Assets/Modules/TriageTrainer/ScriptableObjects/Items` 에 위치시키고 있습니다.
...
- 프리팹: `Assets/Modules/TriageTrainer/Prefabs/Items/`
