namespace MultiplayerInfrastructure.Registry
{
  ...
  ///
  /// `Registry.TrySpawnEntityPreset(..., desiredEntityIdentifier, ...)` 가
  /// Instantiate 직후, 인스턴스의 자가 등록(예: NetworkBehaviour.OnStartClient) 이 일어나기 전에
  /// 이 메서드를 호출하여, 하나의 프리셋에서 인스턴스별 식별자(예: patient_a/_b/_c)를
  /// 부여할 수 있게 한다.
  /// </summary>
