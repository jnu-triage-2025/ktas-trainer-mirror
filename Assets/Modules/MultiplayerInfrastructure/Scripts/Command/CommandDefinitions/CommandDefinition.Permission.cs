...
namespace MultiplayerInfrastructure.Command
{
  ...
  public class CommandDefinition_Permission : IChatCommandModel, IChatCommandUsage
  {
    ...
    public System.Collections.Generic.IReadOnlyList<UsageLine> UsageLines => new[]
    {
      ...
      new UsageLine("permission role set <role> contains add <role2>", "Add role inheritance."),
      new UsageLine("permission role set <role> contains remove <role2>","Remove role inheritance."),
