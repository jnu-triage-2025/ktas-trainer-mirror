...
그 뒤 lucide-convert.sh 스크립트를 사용해 Unity에서 사용할 수 있는 png 파일로 변환합니다. 이 스크립트는 stroke 렌더링을 보존하기 위해 `rsvg-convert`를 사용하며, Icons-Lucide 폴더의 모든 SVG 파일이 Icons 폴더에 PNG로 변환됩니다.  
